...
if env.ENVIRONMENT == "PROD":
    # Use PostgreSQL as the database backend in production
    DATABASES = {
        "default": {
    ...
    # Use SQLite as the database backend for development and other environments
    DATABASES = {
        "default": {
...
SIMPLE_JWT = {
    ...
    "UPDATE_LAST_LOGIN": True,  # Flag to update last login timestamp upon token refresh
}
